...
$(function () {
	...
	$('#fullpage').fullpage({
		...
		onLeave: function (index, nextIndex, direction) {
			...
			if (nextIndex === 2) {
			    $('.bombgirl_right').addClass('active', 1500, 'easeOutQuart', function () {
				...
				setTimeout(function () {
					$('.ball_left').addClass('active', 1000, undefined, function(){
						$('.section_register').bind('mousemove', function(e){
							var px = e.pageX,
								py = e.pageY,
								wx = $(this).width() / 2,
...
var main_video = '<div class="video"><a class="pop_close" href="#"><img src="/Contents/am.nexon.com/CBTPre/en/images/pc/pop_close.png" alt="" /></a><iframe width="" height="" src="{video_src}" frameborder="0" allowfullscreen=""></iframe>' +
				'</div>';
